...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Blog",
          description: "Technical posts about Control Systems, Robotics, and Embedded Systems.",
          section: "Navigation menu",
          handler: () => {
          ...
          title: "Publications",
          description: "Academic papers and publications in reverse chronological order.",
          section: "Navigation menu",
          handler: () => {
          ...
          title: "Projects",
          description: "My technical projects on Embedded Systems, Robotics, and Power Electronics.",
          section: "Navigation menu",
          handler: () => {
          ...
          title: "Repositories",
          description: "Open-source projects and code repositories from my GitHub profile.",
          section: "Navigation menu",
          handler: () => {
          ...
          title: "CV",
          description: "Detailed breakdown of my academic and professional qualifications. You can download the PDF version from the top right.",
          section: "Navigation menu",
          handler: () => {
          ...
          title: "Teaching",
          description: "Technical workshops, seminars, and mentorship activities I have conducted.",
          section: "Navigation menu",
          handler: () => {
        ...
        handler: () => {
          ...
          section: 'Languages',
          handler: () => {
            window.location.href = "/tr-tr" + updatedUrl;
          },
        },{
      id: 'light-theme',
